...
// ================== Kalibrasi Arus ==================
// DC 20A
const float DC_ZERO_POINT_OFFSET = 0.0; 
const float sensitivityDC = 0.100;      
...
void setup() {
  ...
  // Cetak header CSV sekali
  Serial.println("VAC,VDC,IDC,IAC,Wind,Temp,Hum");
}
...
void loop() {
  ...
  float iDC = iDC_smoothed - DC_ZERO_POINT_OFFSET; 
  if (iDC < 0.1) iDC = 0.0;
  ...
  // 6. Output CSV (angka saja, dipisah koma)
  Serial.print(vFinalAC, 2); Serial.print(",");
  Serial.print(vFinalDC, 2); Serial.print(",");
  Serial.print(iDC, 2); Serial.print(",");
  Serial.print(iAC, 2); Serial.print(",");
  Serial.print(windSpeed, 2); Serial.print(",");
  Serial.print(suhu, 1); Serial.print(",");
